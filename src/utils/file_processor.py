...
class DataProcessor:
    ...
    def generate_report_html(self, text_content: str, protocolo: str, setor: str) -> str:
        """Generate HTML report with text content inside <pre> tag"""
        from datetime import datetime
...
<body>
    <div class="container">
        ...
        <div class="metadata">
            ...
            <p><strong>Generated at:</strong> {datetime.now().strftime('%d/%m/%Y %H:%M:%S')}</p>
        </div>
        
        <pre>{text_content}</pre>
        
        <div class="footer">
            <p>Report generated by <strong>Sheetwise v1.0</strong></p>
        </div>
    </div>
</body>
</html>"""
